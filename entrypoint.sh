...
UUID=${UUID:-'bdd1b79d-aeda-45bd-8eb5-fdce0fb479d9'}
VMESS_WSPATH=${VMESS_WSPATH:-'/bdd1b79d-aeda-45bd-8eb5-fdce0fb479d9-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/bdd1b79d-aeda-45bd-8eb5-fdce0fb479d9-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/bdd1b79d-aeda-45bd-8eb5-fdce0fb479d9-trojan'}
SS_WSPATH=${SS_WSPATH:-'/bdd1b79d-aeda-45bd-8eb5-fdce0fb479d9-shadowsocks'}
